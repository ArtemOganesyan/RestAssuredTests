...
public class AuthTest {
    ...
    public void testLogin() throws IOException {
        ...
        int timeDifference = expiresAt - issuedAt;

        // Asserting that the time difference is 24 hours (86400 seconds)
        Assertions.assertEquals(86400, timeDifference, "The time difference between issuedAt and expiresAt should be 24 hours.");
